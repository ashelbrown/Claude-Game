...
public static class Bestiary {
    ...
    public static readonly EnemyDef[] All = {
        new EnemyDef {
            ...
            MeleeDamage = 15f, MeleeRange = 2.2f, MeleeInterval = 1.15f, MeleeWindup = 0.4f,
        ...
        new EnemyDef {
            ...
            WeaponDamage = 8f, FireInterval = 0.85f, BurstCount = 3, BurstInterval = 0.12f,
            ProjectileSpeed = 46f, Spread = 0.055f, WeaponRange = 40f,
        ...
        new EnemyDef {
            ...
            WeaponDamage = 15f, FireInterval = 1.35f, BurstCount = 2, BurstInterval = 0.18f,
        ...
        new EnemyDef {
            ...
            WeaponDamage = 7f, FireInterval = 1.1f, BurstCount = 2, BurstInterval = 0.14f,
        ...
        new EnemyDef {
            ...
            WeaponDamage = 19f, FireInterval = 1.15f, BurstCount = 4, BurstInterval = 0.09f,
        ...
        new EnemyDef {
            ...
            WeaponDamage = 22f, FireInterval = 0.85f, BurstCount = 5, BurstInterval = 0.08f,
            ProjectileSpeed = 60f, Spread = 0.035f, WeaponRange = 60f,
            SlamDamage = 150f, SlamRadius = 11f, SlamCooldown = 9f, SlamWindup = 1.05f,
            Phases = new[] {
