...
export const FACTIONS = {
  severed: {
    ...
    body: [0.30, 0.26, 0.34], accent: [0.95, 0.45, 0.15], eye: [1.0, 0.72, 0.2], cloth: [0.42, 0.18, 0.20],
  },
  hollow: {
    id: 'hollow', name: 'The Hollow',
    desc: 'Something older than the war, still keeping its appointments.',
    body: [0.26, 0.30, 0.34], accent: [0.55, 0.35, 1.0], eye: [0.75, 0.5, 1.0], cloth: [0.14, 0.16, 0.26],
  },
};
...
export const ENEMIES = {
  ...
  husk: {
    ...
    ai: 'melee', melee: { damage: 22, range: 2.2, rate: 1.0, windup: 0.35 },
  ...
  marauder: {
    ...
    ai: 'ranged', weapon: { damage: 13, rate: 0.5, burst: 3, burstDelay: 0.12, speed: 46, spread: 0.05, range: 40, color: [1, 0.55, 0.2] },
  ...
  lancer: {
    ...
    ai: 'ranged', weapon: { damage: 24, rate: 0.9, burst: 2, burstDelay: 0.18, speed: 58, spread: 0.02, range: 55, color: [1, 0.4, 0.15] },
  ...
  reaver: {
    ...
    ai: 'sniper', weapon: { damage: 62, rate: 2.6, telegraph: 1.1, hitscan: true, range: 110, color: [1, 0.25, 0.25] },
  ...
  shank: {
    ...
    ai: 'ranged', weapon: { damage: 11, rate: 0.75, burst: 2, burstDelay: 0.14, speed: 40, spread: 0.06, range: 34, color: [1, 0.6, 0.2] },
  ...
  captain: {
    ...
    ai: 'ranged', weapon: { damage: 34, rate: 0.75, burst: 4, burstDelay: 0.09, speed: 52, spread: 0.045, range: 45, color: [0.4, 0.9, 1] },
  ...
  gnaw: {
    ...
    ai: 'melee', melee: { damage: 18, range: 2.0, rate: 0.8, windup: 0.25 },
  ...
  chanter: {
    ...
    ai: 'ranged', weapon: { damage: 20, rate: 0.85, burst: 1, speed: 34, spread: 0.03, range: 44, color: [0.7, 0.45, 1] },
  ...
  veilwitch: {
    ...
    ai: 'caster', weapon: { damage: 30, rate: 1.6, speed: 26, spread: 0.02, range: 46, seek: 0.9, color: [0.75, 0.4, 1] },
  ...
  hollowKnight: {
    ...
    ai: 'ranged', weapon: { damage: 44, rate: 1.1, burst: 1, speed: 38, spread: 0.02, range: 40, splash: 3.0, color: [1, 0.5, 0.2] },
    melee: { damage: 70, range: 3.4, rate: 1.4, windup: 0.45 },
  ...
  colossus: {
    ...
    ai: 'boss', weapon: { damage: 26, rate: 0.16, beam: true, range: 40, color: [0.75, 0.4, 1] },
    slam: { damage: 180, radius: 9, cooldown: 8, windup: 1.0 },
  ...
  kell: {
    ...
    ai: 'boss', weapon: { damage: 40, rate: 0.5, burst: 5, burstDelay: 0.08, speed: 60, spread: 0.03, range: 60, color: [0.4, 0.9, 1] },
    slam: { damage: 240, radius: 11, cooldown: 9, windup: 0.9 },
  ...
  warpriest: {
    ...
    ai: 'boss', weapon: { damage: 30, rate: 0.2, beam: true, range: 46, color: [1, 0.45, 0.2] },
    slam: { damage: 210, radius: 10, cooldown: 7.5, windup: 1.0 },
    phases: [
